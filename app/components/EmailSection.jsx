    ...
    <section className="grid md:grid-cols-2 my-12 md:my-12 py-12 gap-4 relative">
      ...
      <div className="z-10">
        ...
        <p className="text-[#ADB7BE] mb-4 max-w-md">
          ...
          nemo nulla. Ullam odit atque eos error provident suscipit sit
          pariatur.
        </p>
      ...
      <div>
        <form className="flex flex-col">
          ...
          <div className="mb-6">
            <label
              htmlFor="message"
              className="text-white block text-sm nb-2 font-medium"
            >
              Message
            </label>
            <textarea
          ...
          <button type="submit" className="bg-amber-500 hover:bg-amber-600 text-white font-medium py-2.5 px-5 rounded-lg w-full">Send Message</button>
        </form>
      </div>
    </section>
  );
